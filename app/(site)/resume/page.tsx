        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <FadeIn>
            <div>
              ...
              <p className="text-lg text-muted-light">Nashville, TN</p>
              <div className="mt-3 flex flex-wrap items-center gap-4 text-sm">
                <a
                  href="mailto:stallingsaudio@gmail.com"
                ...
                >
                  ...
                  stallingsaudio@gmail.com
                </a>
                <a
                  href="https://github.com/jstallings2"
                  className="flex items-center gap-2 text-accent transition-colors hover:text-accent/80"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  ...
                  github.com/jstallings2
                </a>
                <a
                  href="https://www.linkedin.com/in/jacob-stallings/"
                  className="flex items-center gap-2 text-accent transition-colors hover:text-accent/80"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  ...
                  linkedin.com/in/jacob-stallings
                </a>
              </div>
            </div>
          </FadeIn>
